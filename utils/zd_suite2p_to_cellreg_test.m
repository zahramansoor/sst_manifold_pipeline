...
results_directory= fullfile(pth,'e201_week1-3', 'Results') ;
...
number_of_sessions=3; %remember to change no of sessions
file_names=cell(1,number_of_sessions);
fls = dir(fullfile(fileroot, "fmats\converted_e201*week*.mat"));
...
reference_session_index=2; % CHANGED BY ZD FROM 1
